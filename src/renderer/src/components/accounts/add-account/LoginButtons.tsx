interface LoginButtonsProps {
  onGoogleLogin: () => void
  onGithubLogin: () => void
  onBuilderIdLogin: () => void
  isLoading?: boolean
}

export function LoginButtons({ onGoogleLogin, onGithubLogin, onBuilderIdLogin, isLoading }: LoginButtonsProps) {
  return (
    <div className="space-y-3 px-2">
      {/* Google */}
      <button
        className="group w-full h-14 flex items-center px-4 gap-4 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl transition-all duration-200 hover:shadow-md hover:border-primary/30 disabled:opacity-50 disabled:cursor-not-allowed"
