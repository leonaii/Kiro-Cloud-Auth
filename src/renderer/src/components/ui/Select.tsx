...
export function Select({ value, options, onChange, placeholder = '请选择', className, disabled }: SelectProps) {
  ...
  return (
    <div ref={ref} className={cn('relative', className)}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-1 py-1 rounded-xl border border-border/50 bg-popover/90 backdrop-blur-xl shadow-xl shadow-black/5 z-50 animate-in fade-in-0 zoom-in-95 duration-200 overflow-hidden">
